...
LISTING_URL = "/casas-departamentos-venta-capital-federal.html"
...
def test_cli_live_caba_casas_departamentos_venta_relevance_pagina_1(
    tmp_path: Path,
) -> None:
    config_path = tmp_path / "zonaprop-caba-casas-deptos-venta-relevance.json"
    config_path.write_text(
        json.dumps(
            {
                "zonaprop": {
                    "filters": FILTERS,
                    "label": "zonaprop-caba-casas-deptos-venta-relevance",
    ...
    assert request_body["province"] == 6
